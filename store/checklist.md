...
- ☐ Přihlásit se do **Apple Small Business Program** (15 % provize —
  viz `store/monetization.md`, schválení trvá dny).
...
9. ☐ Pricing: aplikace **Free**; dostupnost — minimálně Česko a
   Slovensko (⚠ doporučení: launch jen CZ+SK, rozšíření později —
   anglická lokalizace listingu je hotová, ale UI je česky).
